...
unique_types : (  t : Tm ** ty : Ty ** ty' : Ty
               ** (HasType gamma t ty, HasType gamma t ty', Not (ty = ty')) )
unique_types =
  (  InL TyNat (Const 0) ** TySum TyNat TyNat ** TySum TyNat TyBool
  ** (T_InL T_Const, T_InL T_Const, \prf => case prf of Refl impossible) )
